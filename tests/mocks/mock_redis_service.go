// tests/mocks/mock_redis_service.go
...
func (_m *RedisService) Get(key string) (string, error) {
	ret := _m.Called(key)
...
func (_m *RedisService) Set(key string, value interface{}, expiration time.Duration) error {
